"""Prueba algunas operaciones importantes sobre nuestro flujo de trabajo en cli"""
import unittest
...
class TestClasificarIndices(unittest.TestCase):
    ...
    def test_espacio_requerido(self):
        """¿Es capaz de obtener el espacio que se requiere borrar correctamente"""
    ...
    def test_espacio_requerido_libre_ayuda(self):
        """¿Es capaz de considerar correctamente el espacio libre actual?"""
        from esbackup.cli import calcular_espacio_requerido
    ...
    def test_espacio_requerido_libre_mayor(self):
        """¿Es capaz de reconocer que el espacio libre actual es mayor que el
        requerido a borrar, por lo que no necesita borrar nada"""
        from esbackup.cli import calcular_espacio_requerido
    ...
    def test_espacio_usado_indices(self):
        """¿Es capaz dar una estimación del espacio necesario para indices nuevos?"""
    ...
    def test_espacio_usado_indices_segundo_caso(self):
        """Segundo caso sobre la cuestión de espacio necesario para indices nuevos"""
        from esbackup.esbackup import espacio_usado_indices
        from esbackup.esbackup import clasificar_indices
        tabla = clasificar_indices(self.indices)
