#!/usr/bin/python3
"""El comando principal de toda la aplicación.
Existe un especial detalle en que sea especialmente legible por no-programadores"""
...
def calcular_espacio_requerido(espacio_ultimos_indices, porcentaje_requerido, espacio_usado, espacio_libre):
    """Ejecuta un algoritmo simple para calcular el espacio que tenemos que liberar del disco"""
